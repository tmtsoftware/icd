...
class TypescriptCodeGenerator(db: IcdDb) {
  ...
  def generate(
    ...
    val query          = new CachedIcdDbQuery(db, Some(List(sv.subsystem)), None, Map.empty)
    ...
    f.println(s"""// This file contains the API for $s and was generated by the icd-db command.
                 |// DO NOT EDIT.
